...
public class BoosterReducePaddle extends Booster {
    public BoosterReducePaddle(GameCanvas gameCanvas) {
        super(gameCanvas);
    }
    ...
    public void init(Brick brick) {
        super.init(brick);
        setPoints(1000);
        setImage(ImageCache.getImage("powerUpReducePaddle"));
        setPower(Power.REDUCED_PADDLE);
    }
}